...
client = Bot(command_prefix='?', description="hello")

DISCORD_TOKEN = os.environ['discordtoken']
API_KEY = os.environ['apikey']

#this limit is because the Perspective API has an API request limit of 1/second
...
@client.event
async def on_button_click(interaction): #analyzes buttons for the modqueue
